...
<div class="content px-2 py-5 bg-gradient-primary">
	<h4 class="my-3"><b>
			<?= !isset($id) ? "Create New Response" : "Update Response Details" ?>
		</b></h4>
</div>
				...
				<div class="container-fluid">
					<form action="" id="response-form">
						...
						<div class="form-group">
							...
							<textarea type="text" name="response" id="response"
								class="form-control form-control-sm rounded-0"
								required><?php echo isset($response) ? $response : ''; ?></textarea>
						</div>
						<div class="form-group">
								...
								while ($row = $kw_qry->fetch_assoc()):
									...
									<div class="row bg-gradient-light align-items-center kw-item" style="height:4.5em">
										<div class="col-11 border m-0 px-2 py-1 h-100">
											<textarea name="keyword[]" cols="30" rows="2"
												class="form-control form-control-sm rounded-0" required="required"
												style="resize:none"><?= $row['keyword'] ?></textarea>
										</div>
										<div
											class="col-1 border m-0 px-2 py-1 text-center align-items-center h-100 justify-content-center d-flex">
											<div class="col-auto">
												<button class="btn-outline-danger btn btn-sm rounded-0 rem-item"
						...
						<div class="text-right">
							<button class="btn btn-primary btn-sm rounded-0" type="button" id="add_kw_item"><i
									class="far fa-plus-square mb-n2 mr-1"></i>Add Keyword Item</button>
						</div>
						<div class="clear-fix mt-3"></div>
						<div class="row bg-gradient-primary">
						...
						<div id="suggestion-list" class="mb-3">
							<?php if (isset($id)): ?>
								...
								while ($row = $sg_qry->fetch_assoc()):
									...
									<div class="row bg-gradient-light align-items-center sg-item" style="height:4.5em">
										<div class="col-11 border m-0 px-2 py-1 h-100">
											<textarea name="suggestion[]" cols="30" rows="2"
												class="form-control form-control-sm rounded-0"
												style="resize:none"><?= $row['suggestion'] ?></textarea>
										</div>
										<div
											class="col-1 border m-0 px-2 py-1 text-center align-items-center h-100 justify-content-center d-flex">
											<div class="col-auto">
							...
							<div class="row bg-gradient-light align-items-center sg-item" style="height:4.5em">
								<div class="col-11 border m-0 px-2 py-1 h-100">
									<textarea name="suggestion[]" cols="30" rows="2"
										class="form-control form-control-sm rounded-0" style="resize:none"></textarea>
								</div>
								<div
									class="col-1 border m-0 px-2 py-1 text-center align-items-center h-100 justify-content-center d-flex">
									<div class="col-auto">
						...
						<div class="text-right">
							<button class="btn btn-primary btn-sm rounded-0" type="button" id="add_suggestion_item"><i
									class="far fa-plus-square mb-n2 mr-1"></i>Add Suggestion Item</button>
						</div>
					</form>
				</div>
			</div>
			<div class="card-footer py-1 text-center">
				<button class="btn btn-sm btn-primary bg-gradient-primary rounded-0" form="response-form"><i
						class="fa fa-save"></i> Save</button>
				<a class="btn btn-sm btn-light bg-gradient-light border rounded-0" href="./?page=responses"><i
